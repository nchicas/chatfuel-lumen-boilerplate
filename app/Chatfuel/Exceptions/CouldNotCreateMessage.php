...
class CouldNotCreateMessage extends \Exception
{
    ...
    /**
     * Thrown when number of replies in message exceeds.
     *
     * @return static
     */
    public static function messageRepliesLimitExceeded()
    {
        return new static('You cannot add more than 3 replies in 1 notification message.');
    }
}
